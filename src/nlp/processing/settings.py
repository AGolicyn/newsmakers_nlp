...
def _load_nlp(lang: str):
    if lang == 'RU':
        with open('/src/nlp/processing/nlp_data/ru_core_news_lg.pickle', 'rb') as f:
            ru_nlp = pickle.load(f)
        return ru_nlp
    elif lang == 'EN':
        with open('/src/nlp/processing/nlp_data/en_core_web_lg.pickle', 'rb') as f:
            en_nlp = pickle.load(f)
        return en_nlp
    elif lang == 'DE':
        with open('/src/nlp/processing/nlp_data/de_core_news_lg.pickle', 'rb') as f:
...
# nlp_1 = spacy.load("ru_core_news_lg")
# nlp_2 = spacy.load("en_core_web_lg")
# nlp_3 = spacy.load("de_core_news_lg")
# nlp_data.to_disk('./nlp_data')

# with open('nlp_data/ru_core_news_lg.pickle', 'wb') as f:
#     pickle.dump(nlp_1, f)
#
...
# with open('nlp_data/ru_core_news_lg.pickle', 'rb') as f:
#     ru = pickle.load(f)
